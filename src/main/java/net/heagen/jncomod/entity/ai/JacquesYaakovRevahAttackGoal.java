...
public class JacquesYaakovRevahAttackGoal extends MeleeAttackGoal {
    private final JacquesYaakovRevahEntity entity;
    ...
    public JacquesYaakovRevahAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((JacquesYaakovRevahEntity) pMob);
    }
